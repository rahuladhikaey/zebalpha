    ...
    return (
      <main className="flex min-h-screen flex-col items-center justify-center bg-black px-6 text-center">
        <div className="max-w-md w-full rounded-[2.5rem] bg-zinc-950 p-10 border border-zinc-800 shadow-2xl">
          ...
          <p className="mt-3 text-zinc-400 font-medium">You need to be logged in to view your order history.</p>
    ...
    <main className="min-h-screen bg-black text-white">
      ...
      <section className="mx-auto max-w-4xl px-4 py-12 md:px-8">
        <div className="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            <span className="text-[10px] font-black uppercase tracking-[0.4em] text-zinc-400">Purchase History</span>
                ...
                <div key={order.id} className="group relative overflow-hidden rounded-[2.5rem] bg-zinc-950 p-6 md:p-8 border border-zinc-800 shadow-2xl transition-all hover:border-zinc-700">
                    ...
                    <div className="space-y-4 flex-1">
                      <div className="flex flex-wrap items-center gap-3">
                        ...
                        <span className={`rounded-full px-4 py-1.5 text-[10px] font-black uppercase tracking-widest border ${
                          order.order_status === "PENDING" ? "bg-zinc-900 border-zinc-700 text-zinc-300" :
                          order.order_status === "SHIPPED" ? "bg-zinc-800 border-zinc-600 text-white" :
                  ...
                  <div className="mt-8 flex items-center justify-between border-t border-zinc-800 pt-6">
                    ...
                    <button
                      ...
                      className="text-[10px] font-black uppercase tracking-widest text-white bg-zinc-900 border border-zinc-800 hover:bg-zinc-800 px-3.5 py-2 rounded-xl transition cursor-pointer flex items-center gap-1.5"
                    >
                  ...
                  {expandedOrderId === order.id && (
                    <div className="mt-6 pt-6 border-t border-zinc-800 space-y-6">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-4 relative z-10">
                          ...
                          <div className="flex md:flex-col items-center md:text-center gap-4 md:gap-2">
                            ...
                            <div className="flex flex-col md:items-center">
                              <span className="text-xs font-black text-white">Order Confirmed</span>
                            ...
                            return (
                              <div className="flex md:flex-col items-center md:text-center gap-4 md:gap-2">
                                <div className={`h-8 w-8 rounded-full flex items-center justify-center font-black text-xs border-2 border-black shrink-0 z-20 transition-all ${
                                  isActive ? "bg-white text-black shadow-xl" : "bg-zinc-800 text-zinc-500"
                                }`}>
                                  {isActive ? "✓" : "2"}
                                </div>
                                <div className="flex flex-col md:items-center">
                                  <span className={`text-xs font-black ${isActive ? "text-white" : "text-zinc-500"}`}>Dispatched</span>
                                  <span className="text-[9px] font-bold text-zinc-400 mt-0.5">
                          ...
                          {(() => {
                            ...
                            return (
                              <div className="flex md:flex-col items-center md:text-center gap-4 md:gap-2">
                                ...
                                <div className="flex flex-col md:items-center">
                                  <span className={`text-xs font-black ${isActive ? "text-white" : "text-zinc-500"}`}>Shipped with Delivery</span>
                                  <span className="text-[9px] font-bold text-zinc-400 mt-0.5">
                          ...
                          {(() => {
                            ...
                            return (
                              <div className="flex md:flex-col items-center md:text-center gap-4 md:gap-2">
                                ...
                                <div className="flex flex-col md:items-center">
                                  <span className={`text-xs font-black ${isActive ? "text-white animate-pulse" : "text-zinc-500"}`}>Delivered</span>
                                  <span className="text-[9px] font-bold text-zinc-400 mt-0.5">
                      ...
                      <div className="grid md:grid-cols-2 gap-4 bg-zinc-900 p-4 rounded-2xl border border-zinc-800">
                        ...
                        <div className="space-y-1">
                          <p className="text-[9px] font-black uppercase tracking-widest text-zinc-400">Contact Number</p>
