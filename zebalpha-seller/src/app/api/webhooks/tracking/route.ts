...
/**
 * Real-time Delivery & Shipment Webhook Receiver
 * Listens for tracking updates from courier partners and automatically updates
...
export async function POST(req: Request) {
  try {
    ...
    // Map courier status to Zebalpha system status
    let mappedStatus = "";
