...
export default function DashboardOverview({
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500 text-white">
      ...
      <div className="relative overflow-hidden rounded-[2.5rem] bg-zinc-950 border border-zinc-800 p-8 sm:p-12 shadow-2xl text-white">
        <div className="absolute inset-0 bg-gradient-to-br from-white/[0.04] to-zinc-900/40"></div>
        <div className="absolute -right-20 -top-20 h-64 w-64 rounded-full bg-white/[0.03] blur-3xl"></div>
        <div className="absolute -bottom-20 -left-20 h-64 w-64 rounded-full bg-white/[0.02] blur-3xl"></div>

        <div className="relative z-10 flex flex-col xl:flex-row xl:items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl sm:text-4xl font-black tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-white via-zinc-200 to-zinc-400">
        ...
        {dateFilter === "custom" && (
          <div className="relative z-10 mt-6 grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-md p-4 bg-zinc-900/90 rounded-2xl border border-zinc-800">
            <div>
              ...
              <input
                ...
                className="w-full bg-zinc-950 border border-zinc-800 rounded-xl px-3 py-2 text-xs font-bold text-white outline-none focus:border-white"
              />
            </div>
            <div>
              <label className="block text-[10px] font-black uppercase text-zinc-400 mb-1">
        ...
        {/* Auto Refresh Config */}
        <div className="relative z-10 mt-6 border-t border-zinc-800/80 pt-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 text-xs font-bold text-zinc-400">
            ...
            <select
              ...
              className="bg-zinc-900 border border-zinc-800 rounded-xl px-2 py-1 text-[11px] font-bold text-white outline-none focus:border-white disabled:opacity-40"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {/* Customer KPIs */}
        <div className="bg-zinc-950 rounded-[2rem] p-6 border border-zinc-800 shadow-xl text-white">
          <h4 className="text-sm font-black text-white uppercase tracking-wider pb-4 border-b border-zinc-800 mb-6">
          ...
          <div className="space-y-3">
            {[
              { label: "New Customers Today", count: customerStats.newToday, color: "text-white bg-zinc-900 border border-zinc-800" },
              { label: "New Customers This Week", count: customerStats.newThisWeek, color: "text-white bg-zinc-900 border border-zinc-800" },
              { label: "New Customers This Month", count: customerStats.newThisMonth, color: "text-white bg-zinc-900 border border-zinc-800" },
              { label: "Active Customers (Purchased)", count: customerStats.activeCustomers, color: "text-white bg-zinc-900 border border-zinc-800" },
            ].map((stat) => (
              <div key={stat.label} className="flex justify-between items-center py-2 border-b border-zinc-900 last:border-0">
        ...
        <div className="bg-zinc-950 rounded-[2rem] p-6 border border-zinc-800 shadow-xl text-white">
          ...
          <div className="grid grid-cols-2 gap-4 mb-6">
            <div className="p-4 bg-zinc-900 rounded-2xl border border-zinc-800">
              <span className="text-[10px] font-black uppercase text-zinc-400">Total Catalog</span>
              <p className="mt-3 text-3xl font-black text-white">
                {productStats.totalProducts}
              </p>
            </div>
            <div className="p-4 bg-zinc-900 rounded-2xl border border-zinc-800">
              <span className="text-[10px] font-black uppercase text-zinc-400">Out of Stock</span>
              <p className="mt-3 text-3xl font-black text-white">{productStats.outOfStock}</p>
            </div>
          </div>

          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b border-zinc-900">
              <span className="text-xs font-bold text-zinc-400">Active Products Listed</span>
              <span className="px-2.5 py-1 rounded-full text-xs font-black text-white bg-zinc-900 border border-zinc-800">
                {productStats.activeProducts}
              </span>
            </div>
            <div className="flex justify-between items-center py-2 border-b border-zinc-900">
              <span className="text-xs font-bold text-zinc-400">Low Stock Alert (≤ limit)</span>
              <span className={`px-2.5 py-1 rounded-full text-xs font-black ${
                productStats.lowStock > 0 ? "text-white bg-zinc-900 border border-zinc-700 animate-pulse" : "text-zinc-400 bg-zinc-900 border border-zinc-800"
              }`}>
